...
var Dia_chi_Media = "https://dich-vu-media-dien-thoai.herokuapp.com/"
    //************** Xử lý Lưu trữ ***********
...
function Tao_The_hien_Dien_thoai(Dien_thoai, Th_Cha) {
    ...
    Th_Cha.appendChild(the_hien)
    var Chuoi_HTML = `<div class="card m-2 p-2" style="width:18rem !important">
  <img class="card-img-top" src="${Dia_chi_Media}${Dien_thoai.Ma_so}.png" alt="${Dien_thoai.Ma_so}">
  <div class="card-body">
      <h6  class="card-title text-primary">${Dien_thoai.Ten}</h6>
...
// Tao thể hiện đăng nhập
function Tao_The_hien_Dang_nhap(Th_Cha) {
    var noi_dung_HTML = `<div  style="width:30rem; margin-left : auto ; margin-right :auto ;margin-top : 200px; padding:10px" id="Th_Khung_Dang_nhap" class="table-bordered">
    <div class="form-group">
      <label for="Th_Ten_Dang_nhap">Tên đăng nhập</label>
      <input type="text" class="form-control" id="Th_Ten_Dang_nhap" placeholder="Nhập Tên đăng nhập" value="KH_1">
    </div>
    <div class="form-group">
      <label for="Th_Mat_khau">Mật khẩu</label>
      <input type="password" class="form-control" id="Th_Mat_khau" placeholder="Nhập mật khẩu" value="KH_1">
    </div>
    
    <button type="button" class="btn btn-primary" id="Th_Dang_nhap" style="margin-left : 110px">Đăng nhập</button>
    <button type="button" class="btn btn-primary" id="Th_Huy" style="margin-left : 20px;width: 103px">Hủy</button>
  </div>`
